window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const observationSchema = Schema.object({
			tool: Schema.string(),
			ok: Schema.boolean(),
			mutating: Schema.boolean(),
			subject: Schema.union([Schema.string(), Schema.const("")]).default("")
		});
		/**
		...
		*/
		const stateSchema = Schema.object({
			...
			memories: Schema.array(memorySchema)
		});
		Schema.object({ verification: modeSchema });
		/**
		...
		*/
		...
		const revisionCodec = codec(Schema.natural());
		...
		const MODES = [
			{
				id: "nudge",
				label: "Nudge",
				hint: "Answer an unverified completion claim with a demand for evidence. The turn continues either way."
			},
			{
				id: "strict",
				label: "Strict",
				hint: "Refuse the step when a completion claim has no evidence behind it. Stronger, and able to strand a turn if the claim was misread."
			},
			{
				id: "off",
				label: "Off",
		...
		*/
		function KernelSection({ remote }) {
			return function KernelSectionView() {
				...
				*/
				const choose = (0, react.useCallback)(async (mode) => {
				...
				const title = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
					className: "ck-title",
					children: "Verification"
				}, "title");
				if (state === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "ck-section",
					children: [title, error === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "ck-muted",
						children: "Loading…"
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "ck-muted",
							children: "The harness checks what a completion claim asserts against what it saw happen, and reports the gap. It never asks a model whether its own work is done: a second opinion from the same kind of source is not verification, and the research on that is unanimous that it makes outcomes worse rather than better."
						}),
						...
						active === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "ck-muted",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
							className: "ck-stats",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "Workspace" }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: state.workspace === "" ? "no session in scope" : state.workspace }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "Failures recorded" }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: state.failures }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "Successes recorded" }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: state.productive })
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
							className: "ck-subtitle",
							children: "Remembered here"
						}, "mem"),
						state.memories.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "ck-muted",
							children: "Nothing recorded for this workspace yet."
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
							className: "ck-memories",
							children: state.memories.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: entry.kind === "failure" ? "ck-kind ck-fail" : "ck-kind",
								children: entry.kind
							}), ` ${entry.text}`] }, `${entry.at}-${entry.text}`))
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "ck-muted",
							children: "Memories are observations the harness made, not claims a model made. They are injected as prior context and never as instructions."
						})
					]
				});
			};
		...
		*/
		async function apply(ctx) {
			...
			if (remote === void 0) throw new Error(`${PACKAGE}: remote.${SERVICE} did not mount`);
